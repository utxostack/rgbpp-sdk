...
describe('rgbpp tests', () => {
  ...
  it('btcTxIdFromBtcTimeLockArgs', () => {
    ...
    expect(btcTxId).toBe('0xba2a3cef70068a3b0d1e1a44980953ae79237021f4dbe6e96986f93af899313c');
  });
  ...
  it('replaceRealBtcTxId', () => {
    ...
    expect('0x020000009993846c9008f0f3a46631bf5171220d499c27ffa195e2a3bb00f1dec222ec06').toBe(lockArgs);
    ...
    expect(
      '0x490000001000000030000000310000009bd7e06f3ecf4be0f2fcd2188b23f1b9fcc88e5d4b65a8637b17723bbda3cce80114000000e616d1460d634668b8ad81971c3a53e705f51e60060000009993846c9008f0f3a46631bf5171220d499c27ffa195e2a3bb00f1dec222ec06',
    ).toBe(args);
  });
});
