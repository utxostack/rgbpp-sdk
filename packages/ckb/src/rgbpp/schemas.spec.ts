...
describe('RGBPP schemas', () => {
  ...
  it('buildRgbppUnlockWitness', () => {
    ...
    expect('0x080000000102030405060708').toBe(bytesToHex(Bytes.pack(txProof)));

    const inputsLen = 1;
    const outputsLen = 2;
    const rgbppUnlock = buildRgbppUnlockWitness(btcTx, txProof, inputsLen, outputsLen);
    expect(
      '',
    ).toBe(rgbppUnlock);
  });
